...
import (
	...
	rediscontroller_v1alpha1 "k8s.io/redis-controller/pkg/apis/rediscontroller/v1alpha1"
	versioned "k8s.io/redis-controller/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/redis-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/redis-controller/pkg/client/listers/rediscontroller/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RediscontrollerV1alpha1().Redises(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RediscontrollerV1alpha1().Redises(namespace).Watch(options)
			},
		},
		&rediscontroller_v1alpha1.Redis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rediscontroller_v1alpha1.Redis{}, f.defaultInformer)
}
