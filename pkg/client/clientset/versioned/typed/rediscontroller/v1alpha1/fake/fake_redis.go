...
type FakeRedises struct {
	Fake *FakeRediscontrollerV1alpha1
	ns   string
}

var redisesResource = schema.GroupVersionResource{Group: "rediscontroller.k8s.io", Version: "v1alpha1", Resource: "redises"}

var redisesKind = schema.GroupVersionKind{Group: "rediscontroller.k8s.io", Version: "v1alpha1", Kind: "Redis"}
