...
This repository is published from [kubernetes/kubernetes/staging/src/k8s.io/redis-controller](https://git.k8s.io/kubernetes/staging/src/k8s.io/redis-controller) by the [kubernetes publishing-bot](https://git.k8s.io/publishing-bot). 
